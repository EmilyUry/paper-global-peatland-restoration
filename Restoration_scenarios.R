...
write.csv(data, "Data_sources/Extracted_datafiles/Data_filtered.csv", row.names=FALSE)


write.csv(MC_SGWP20, "Data_sources/Extracted_datafiles/MC_SGWP20.csv", row.names=FALSE)
write.csv(MC_SGWP100, "Data_sources/Extracted_datafiles/MC_SGWP100.csv", row.names = FALSE)
write.csv(MC_2099, "Data_sources/Extracted_datafiles/MC_2099.csv", row.names = FALSE)
write.csv(MC_2010, "Data_sources/Extracted_datafiles/MC_2010.csv", row.names = FALSE)
write.csv(MC_Rewet, "Data_sources/Extracted_datafiles/MC_Rewet.csv", row.names = FALSE)
