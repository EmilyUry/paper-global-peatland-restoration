...
## i.e. rewetted-boreal N2O from wetland N2O
{
  ...
  ## for rice, replace tropical CH4 and N2O with values from Qian et al. 2023
  ## keep CO2 from tropical rice as in the IPCC
  ## for missing CO2 emissions from temperate rice, use 0.79 times the EF for tropical rice
  ## rational, the CH4 and N2O emissions from temperate rice are about 0.79 times as high as those
  ## from tropical rice in the Qian dataset (245 sites). 
  
  ## for missing temperate rice, 
 
  EF_summary[42,] 
  EF_summary[46,] <- list(2, "Rice", "CO2", 940*0.79, NA, NA, NA, 962*0.79)
  EF_summary[41,] <- list(3, "Rice", "CH4", 33694, NA, NA, NA, 31080)
  EF_summary[47,] <- list(2, "Rice", "CH4", 27215, NA, NA, NA, 20634)
  EF_summary[43,] <- list(3, "Rice", "N2O", 203.9, NA, NA, NA, 214.3)
  EF_summary[48,] <- list(2, "Rice", "N2O", 156.3, NA, NA, NA, 205.0)
...
## write out to save
write.csv(mean_long, "Emission_Factors/EF_SD_Summary2.csv", row.names=FALSE)
