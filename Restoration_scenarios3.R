...
filter <- filter[filter$peatland_loss > 0,]
filter <- filter[filter$peatland_loss > 0.00001,] ## removes pixels with ridiculously small peatland loss or no peatland loss
...
write.csv(data, "Data_sources/Extracted_datafiles/Data_filtered3.csv", row.names=FALSE)


write.csv(MC_SGWP20, "Data_sources/Extracted_datafiles/MC_SGWP20_3.csv", row.names=FALSE)
write.csv(MC_SGWP100, "Data_sources/Extracted_datafiles/MC_SGWP100_3.csv", row.names = FALSE)
write.csv(MC_2099, "Data_sources/Extracted_datafiles/MC_2099_3.csv", row.names = FALSE)
write.csv(MC_2010, "Data_sources/Extracted_datafiles/MC_2010_3.csv", row.names = FALSE)
write.csv(MC_Rewet, "Data_sources/Extracted_datafiles/MC_Rewet_3.csv", row.names = FALSE)
