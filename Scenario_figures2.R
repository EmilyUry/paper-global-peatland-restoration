...
MC_2099 <- read.csv("Data_sources/Extracted_datafiles/MC_2099_2.csv")
...
summary.table
write.csv(summary.table, "Data_sources/Extracted_datafiles/Scenario_summary2.csv")
...
table1
write.csv(table1, "table1_v2.csv", row.names=FALSE)
...
ER71 <- Vstat[max.diff.percent,2]
ER71.sd <- Vstat[max.diff.percent,3]
ER71.random <- Vstat[max.diff.percent,4]
ER71.random.sd <- Vstat[max.diff.percent,5]
...
ggsave(filename = "Figures/S1_SGWP20_S4_2010_v2.png",
...
ggsave(filename = "Figures/Multi-objective-compare_v2.png",
       plot = last_plot(), bg = "white",
       width = 6, 
       height = 5, 
       unit = "in",
...
# 1 = both fertilizer and climate  ##519
...
ggsave(filename = "Figures/Multi-objective-maps_v2.png",
       plot = last_plot(), bg = "white",
       width = 3.5*2, 
       height = 3.4*2, 
       unit = "in",
...
summary <- as.data.frame(t(matrix(c("global emissions, restore to intact, GWP20", sum.S1,
                                    ...
                                    "emissions reductions at 71% restored", ER71,
                                    "sd of emissions reductions at 71% restored", ER71.sd,
                                    "emissions reds at 71% restored, randomly", ER71.random,
                                    "sd of ^", ER71.random.sd, 
